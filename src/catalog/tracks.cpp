...
namespace Catalog {
    ...
    {
        byId[(size_t)TrackID::CopyrightBG] = LoadMusicStream("data/audio/music/fluquor_copyright.ogg");
        byId[(size_t)TrackID::Whistle    ] = LoadMusicStream("data/audio/music/whistle.ogg");
    ...
    {
        thread_local static Music missingOgg = {};
